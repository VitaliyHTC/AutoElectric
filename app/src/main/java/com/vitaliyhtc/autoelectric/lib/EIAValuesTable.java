...
public class EIAValuesTable {
    ...
    public EIAValuesTable(EIAValuesLines ab2) {
        switch (EIAValuesTable.a()[ab2.ordinal()]) {
            default: {
                return;
            }
            case 1: {
    ...
    private double[] a(double[] arrd) {
        ...
        if (arrd[0] < (double)(this.B.length - 1)) {
            arrd2[0] = arrd[0] + 1.0;
            arrd2[1] = arrd[1];
            return arrd2;
        }
    ...
    private double[] c(double d2) {
        ...
        d3 = Math.floor(d2);
        return new double[]{Math.floor((d2 - d3) * (double)this.B.length), Math.pow(10.0, d3)};
    }

    private double[] d(double d2) {
        double[] arrd = this.c(d2);
        double[] arrd2 = this.a(arrd);
        double d3 = (this.B[(int)arrd[0]] * arrd[1] - d2) / d2;
        if (Math.abs((this.B[(int)arrd2[0]] * arrd2[1] - d2) / d2) < Math.abs(d3)) {
            return arrd2;
        }
        return arrd;
    }
    ...
    private double[] e(double d2) {
        ...
        double d6 = this.B[(int)arrd[0]] * arrd[1];
        double d7 = 1.0E9;
        double d8 = 0.0;
        double d9 = 0.0;
        do {
            double[] arrd2 = this.d(d2 - d6);
            double d10 = this.B[(int)arrd2[0]] * arrd2[1];
            d4 = d6 + d10 - d2;
            d5 = d9;
            d3 = d8;
            double d11 = d7;
    ...
    private double[] f(double var1) {
        ...
        double var3 = this.B[(int)var15[0]];
        ...
        while(true) {
            ...
            var15 = this.a(var15);
            var9 = this.B[(int)var15[0]] * var15[1];
            if(var9 >= 2.0D * var1) {
    ...
    public void a(double d2) {
        ...
        do {
            ...
            double d7 = d6 / (d5 = this.B[(int)(arrd2 = this.d(d4 = d6 / d2))[0]] * arrd2[1]);
    ...
    public void a(EIAValuesLines ab2) {
        switch (EIAValuesTable.a()[ab2.ordinal()]) {
            default: {
                return;
            }
